...
VALIDATION_RULES = [
    ...
    (r"cd\s+&&\s+", "Use absolute paths or subshells instead of 'cd &&' patterns"),
]
    ...
    for pattern, message in VALIDATION_RULES:
        if re.search(pattern, command):
            ...
            if any(
                ...
                for word in ["dangerous", "insecure", "security"]
            ):
    ...
    if issues:
        ...
        output = {
            "hookSpecificOutput": {
                ...
                "permissionDecisionReason": "Command has potential issues:\n"
