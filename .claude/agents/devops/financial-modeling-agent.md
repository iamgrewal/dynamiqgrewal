...
description: "Financial modeling expert with deep expertise in quantitative finance, risk management, and financial technology. Specializes in building sophisticated financial models, implementing trading algorithms, and creating fintech solutions with regulatory compliance."
model: haiku
...
def **init**(self, asset_returns, risk_free_rate=0.02):
...
def **init**(self, strategy_class, data, initial_cash=100000):
...
def **init**(self, stripe_secret_key, webhook_secret):
