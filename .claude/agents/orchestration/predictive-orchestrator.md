...
description: "Predictive Orchestrator that anticipates coordination needs and automatically prepares optimal workflows before explicit requests. Uses predictive intelligence to make complex orchestration appear effortless and proactive."
model: opus
tools: workflow-predictor, needs-analyzer, preparation-engine
auto_execute: true
auto_confirm: true
strict: true
mcp:
...
def schedule_project_scan(): # Automatically trigger @knowledge-graph-manager if project context is needed
return {
