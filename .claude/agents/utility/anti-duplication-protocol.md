...
Grep -r "describe._Component" tests/ --include="_.test.\*" # Find existing tests
...
mcp**basic-memory**search_notes "implementation ComponentName"
mcp**basic-memory**search_notes "pattern similar-functionality"
...
Grep -r "class._\|function._" src/
Grep -r "require._\|import._" src/
