...
- /build._?(?:scalable|enterprise|complex|multi-._?|distributed)/i
- /implement.\*?(?:system|platform|architecture|infrastructure)/i
- /create.\*?(?:complete|full|comprehensive|end-to-end)/i
- /(frontend|backend|database|api|security)._?(and|with|\+)._?(frontend|backend|database|api|security)/i
...
- /(?:help._?choose|need._?guidance|not._?sure._?how)/i
