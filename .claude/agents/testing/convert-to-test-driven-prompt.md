...
description: "Transform user requests into Test-Driven Development (TDD) style prompts with explicit test cases, success criteria, and implementation structure."
---
